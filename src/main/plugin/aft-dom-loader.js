 ...
 * dom loader
 */
export const loadDom = (path) => new Promise((res) => {
    fetch(path, {
        method: 'GET',
        headers: {
...
export const appendDom = (child, parent) => new Promise((res) => {
    const _obj = { scripts: [] };
    let node;
...
const _emptyDom = () => document.createElement('div');
//# sourceMappingURL=aft-dom-loader.js.map